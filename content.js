...
console.log(temp);
const a = JSON.parse(localStorage.getItem(temp));
console.log(a["username"]);
document.getElementById("account").innerHTML = "Welcome" + " " + a["username"];
document.getElementById("username-setting").innerHTML = a["username"];
document.getElementById("email-setting").innerHTML = a["email"];
